...
export function CustomerReviews() {
  ...
  const openModal = (review: typeof mockReviews[0]) => {
    ...
    <section className="py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          ...
          <button
            onClick={prev}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-16 z-10 bg-white dark:bg-gray-800 shadow-lg rounded-full p-2 hover:shadow-xl transition-shadow duration-200"
                ...
                <div className="blaze-track py-12">
                  {mockReviews.map((review) => (
                    <div key={review.id} className="blaze-slide">
                      <div 
                        className="w-[280px] h-[180px] p-5 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-100 dark:border-gray-700 transform transition-all duration-300 ease-in-out hover:shadow-xl hover:scale-102 hover:-translate-y-0.5 hover:border-gray-200 dark:hover:border-gray-600 cursor-pointer"
