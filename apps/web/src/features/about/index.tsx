  ...
  const renderStars = (rating: number, size: "sm" | "lg" = "sm") => {
    ...
    for (let i = 1; i <= 5; i++) {
      stars.push(
        <Star 
          key={i} 
          className={`${sizeClass} ${i <= rating ? 'fill-yellow-400 text-yellow-400' : 'text-gray-300 dark:text-neutral-700'}`}
        />
      );
    }
    return stars;
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-8 leading-tight">
              Sağlıklı ve Fit Yaşamayı Zevkli ve Kolay Hale Getirmek İçin Varız
            </h1>
            
            <div className="space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed max-w-4xl mx-auto">
              ...
              <p className="text-base md:text-lg">
                Müşteri memnuniyeti ve sağlığı her zaman önceliğimiz olmuştur. Ürünlerimizde, yüksek kalite standartlarına bağlı olarak, sporcuların ve sağlıklı yaşam tutkunlarının ihtiyaçlarına yönelik besleyici çözümler üretirken, optimal besin değerlerini sunuyoruz.
              </p>
              <p className="text-base md:text-lg">
        ...
        <section className="mb-16">
              ...
              {[5, 4, 3, 2, 1].map((rating) => {
                ...
                return (
                  <div key={rating} className="flex items-center gap-3">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400 min-w-[50px] text-right">
                      ({count})
                    </div>
                  </div>
                );
          ...
          <div className="space-y-6 mb-8">
            {currentReviews.map((review) => (
              <div key={review.id} className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 shadow-lg rounded-lg p-6">
        ...
        <section className="text-center bg-gray-50 dark:bg-neutral-950 border border-gray-200 dark:border-neutral-800 rounded-xl p-8">
          ...
          <a 
            href="/contact"
            className="inline-block bg-black hover:bg-gray-800 text-white dark:bg-white dark:hover:bg-gray-200 dark:text-black px-6 py-2 rounded-lg transition-colors"
          >
            İletişim
          </a>
        </section>
